...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified',])->group(function () {
    ...
    Route::middleware('store')->prefix('store')->name('store.')->group(function () {
        ...
        Route::get('/qr-code', [StoreDashboardController::class, 'qrCode'])->name('qr-code');
        Route::get('/qr-code/download', [StoreDashboardController::class, 'downloadQrCode'])->name('qr-code.download');
