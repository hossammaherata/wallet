...
<template>
    <Layout>
        <PageHeader title="Create User" pageTitle="All Users" :href="route('admin.users.index')" />
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    ...
                    <FormSection @submitted="Store">
                        ...
                        <template #actions>
                            ...
                            <p v-if="form.recentlySuccessful" class="alert alert-success mt-3">User Created successfully.</p>
                        </template>
                    </FormSection>
                </BCard>
            </BCol>
