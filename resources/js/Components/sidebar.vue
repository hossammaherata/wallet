  ...
  <BContainer fluid>
    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link menu-link active" href="#categoreySideBar" data-bs-toggle="collapse" role="button"
            aria-expanded="false" aria-controls="categoreySideBar">
            <i class="ri-dashboard-2-line"></i>
            <span data-key="t-dashboards"> {{ $t("t-dashboards") }}</span>
          </a>
          <div class="collapse menu-dropdown active show" id="categoreySideBar">
            <ul class="nav nav-sm flex-column">
             
              <!-- <li class="nav-item">
                <Link :href="route('admin.brand.index')" class="nav-link custom-abc" data-key="t-brands">
                {{ $t("t-brands") }}
                </Link>
              </li> -->
              ...
              <li class="nav-item" v-if="$page.props.auth.user && $page.props.auth.user.type === 'admin'">
                <Link :href="route('admin.wallet-configuration.index')" class="nav-link custom-abc">
                {{ $t('t-fee-settings') }}
                </Link>
              </li>
              ...
              <!-- <li class="nav-item">
                <Link :href="route('admin.cities.index')" class="nav-link custom-abc" data-key="t-cities">
                Cities Management
                </Link>
              </li> -->
              
              <!-- <li class="nav-item">
                <Link :href="route('admin.customers.index')" class="nav-link custom-abc" data-key="t-customers">
                Customers
                </Link>
              </li> -->
